...
class User(Base):
    ...
    paddle_customer_id = Column(String, nullable=True)  # Paddle customer ID for payments
    ...
    emissions_calculations = relationship("EmissionsCalculation", back_populates="user", cascade="all, delete-orphan")
